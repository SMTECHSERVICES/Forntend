    ...
    <>
      <div className={(status) ? '' : 'hidden'}>
        <div className="relative isolate flex items-center gap-x-6 overflow-hidden bg-gray-50 px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
          ...
          <div className="flex flex-1 justify-end" onClick={changestatus}>
            ...
            <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
...

              {
                (isLogin)
                  ...
                  <>
                   <Link to='/login'>
                    <button class="pointer-events-auto ml-8 rounded-md bg-indigo-600 px-3 py-2 text-[0.8125rem]/5 font-semibold text-white hover:bg-indigo-500">Login</button>
                   

                   </Link>

                   <Link to='/Register'>
                    <button class="pointer-events-auto ml-8 rounded-md bg-indigo-600 px-3 py-2 text-[0.8125rem]/5 font-semibold text-white hover:bg-indigo-500">Register</button>
